...
## 4. Conclusiones
  ...
  Realizamos el análisis de los datos obtenidos de las graficas con cada una de las enfermedades:
  ...
  - **Isquemias cardiacas**
  Se puede observar que el resultado de los tres cultivos no ha dado la relación que esperabamos, sino que incluso ha salido a la inversa. Estos resultados al no ser plausibles nos indican que no existe una relación entre ellos.
